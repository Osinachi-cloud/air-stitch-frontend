          ...
          <div className="w-full max-w-md bg-white rounded-3xl shadow-elegant p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#164377] text-white py-2.5 rounded-xl text-sm font-semibold hover:bg-[#123661] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-3 shadow-lg"
              >
                <span>Sign In</span>
