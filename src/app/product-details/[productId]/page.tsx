...
const ProductDetails = () => {
  ...
  // Add check for missing productId
  if (!productId) {
    return (
      <div className="px-2 md:px-6 py-10 w-[90%] m-auto">
        <div className="flex justify-center items-center py-20">
  ...
  const availableColors = product.productVariation?.map(v => v.color) || ["black"];
  const availableSleeveTypes = product.productVariation?.map(v => v.sleeveType) || ["long"];
      ...
      <div className="max-w-7xl mx-auto p-4 md:grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col gap-6 col-span-1 mt-[2rem]">
          <div className="space-y-2">
            ...
            <p className="text-gray-600">
              <span className="font-semibold">Sleeves:</span> Available in {availableSleeveTypes.join(" & ")}
            </p>
            <p className="text-gray-600">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className={`px-4 py-2 rounded-md border ${
                sleeveType === "short" ? "bg-black text-white" : "bg-white text-black"
              }`}
            >
              Short Sleeves
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md border ${
                sleeveType === "long" ? "bg-black text-white" : "bg-white text-black"
              }`}
            >
              Long Sleeves
            </button>
