...
//     const cartItems: CartProduct[] = cartData?.data?.items || cartData?.items || cartData?.data || [];
//     const totalAmount = summaryData?.total || summaryData?.data?.total || 0;
...
//                                             <p className="text-sm">{formatNumberToNaira(product.price)}</p>
...
//                                                 Total {formatNumberToNaira(product.amountByQuantity ?? product.amount * product.quantity)}
//                                             </p>
//                                         </div>
//                                     ))}
...
//                                             <span className="font-semibold">{formatNumberToNaira(totalAmount)}</span>
//                                         </div>
