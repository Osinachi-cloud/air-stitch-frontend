    ...
    return (
        <>
            <div className="flex justify-between items-center mb-4 py-4">
                ...
                <Link href={url} className="bg-[#164377] flex justify-center gap-2 items-center text-xs text-white font-semibold px-3 rounded-md py-2 hover:opacity-90 transition-opacity shadow-card">
